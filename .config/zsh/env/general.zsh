# ╔══════════════════════════════════════════════════════════════╗
# ║                  🌍  ENVIRONMENT: GENERAL                    ║
# ║   Core, tool-independent environment variables & context     ║
# ╚══════════════════════════════════════════════════════════════╝
...
# 🌐  LOCALE & ENCODING
# ────────────────────────────────────────────────────────────────
# Required for proper iTerm terminal behavior and encoding fallback
# Reference: https://gitlab.com/gnachman/iterm2/-/issues/10879#note_1433417922
export LANG=en_US.UTF-8

# ────────────────────────────────────────────────────────────────
# 💻  PLATFORM DETECTION
# ────────────────────────────────────────────────────────────────
# Detects operating system and exposes it for custom setup scripts
# Used globally by $ZDOTDIR/functions/shell_is_*
